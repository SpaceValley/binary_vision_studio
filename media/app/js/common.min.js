...
!function(){const t=document.querySelector(".designs").getBoundingClientRect().top+window.pageYOffset;let e=!1;const n=n=>{window.pageYOffset>t&&([...document.querySelectorAll(".designs__title span")].forEach(t=>{t.style.transform="translate(0px, 0px)",t.style.opacity="1"}),e=!0),e&&o()};window.addEventListener("scroll",n);const o=()=>window.removeEventListener("scroll",n);document.addEventListener("DOMContentLoaded",()=>{[...document.querySelectorAll(".designs__title span")].forEach((t,e)=>{const n=e%2==0?-(e+10)*Math.random()*7:(e+10)*Math.random()*7,o=e%2==0?(e+10)*Math.random()*7:-(e+10)*Math.random()*7;t.style.opacity="0",t.style.transition="all 1s cubic-bezier(0.88, 0.26, 0.3, 0.98)",t.style.transform=`translate(${n}px, ${o}px)`})})}();
